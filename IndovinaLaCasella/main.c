...
void main(){
    ...
    printf("\n\n\n \t\t\t\t\tBENVENUTI IN INDOVINA LA CASELLA\n\n\n");
    printf("\t\t\t\t");
     for(i=0; i<50; i++){
        printf("*");
    }
    ...
    printf("\t\t\t\t3) CHI INDOVINA ALMENO UN RIQUADRO IN CUI SI GENERERA' L' X VINCE IL MONTEPREMI TOTALE, \n");
    printf("\t\t\t\tNEL CASO ACCADE CHE PIU' GIOCATORI INDOVINANO UN RIQUADRO, VINCE CHI HA PIU' RIQUADRI O SI DIVIDE IL MONTEPREMI.\n\n");
